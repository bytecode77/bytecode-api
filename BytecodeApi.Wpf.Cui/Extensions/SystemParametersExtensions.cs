...
namespace BytecodeApi.Wpf.Cui.Extensions;

/// <summary>
/// Provides <see langword="static" /> methods that extend the <see cref="SystemParameters" /> class.
/// </summary>
public static class SystemParametersExtensions
{
	extension(SystemParameters)
	{
		/// <summary>
