...
public static class StringConvertExtensions
{
	...
	/// </summary>
	/// <param name="str">The <see cref="string" /> with a convertible representation of a <see cref="DateOnly" /> value.</param>
	/// <param name="format">A <see cref="string" /> value specifying the format that is used to convert this <see cref="DateOnly" />.</param>
	/// <returns>
	/// The <see cref="DateOnly" /> value that was converted from <paramref name="str" /> and
	/// <see langword="null" />, if conversion failed.
	/// </returns>
	public static DateOnly? ToDateOnly(this string str, string format)
	{
		Check.ArgumentNull(format);
	...
	/// </summary>
	/// <param name="str">The <see cref="string" /> with a convertible representation of a <see cref="TimeOnly" /> value.</param>
	/// <param name="format">A <see cref="string" /> value specifying the format that is used to convert this <see cref="TimeOnly" />.</param>
	/// <returns>
	/// The <see cref="TimeOnly" /> value that was converted from <paramref name="str" /> and
	/// <see langword="null" />, if conversion failed.
	/// </returns>
	public static TimeOnly? ToTimeOnly(this string str, string format)
	{
		Check.ArgumentNull(format);
