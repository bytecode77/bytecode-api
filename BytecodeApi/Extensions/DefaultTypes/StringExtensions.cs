...
public static class StringExtensions
{
	...
	extension(string str)
	{
		...
		/// </summary>
		/// <param name="values">An array of <see cref="string" /> values to compare to this <see cref="string" />.</param>
		/// <returns>
		...
		/// otherwise, <see langword="false" />.
		/// </returns>
		public bool EqualsAny(string[] values, StringComparison comparison)
		{
		...
		/// </summary>
		/// <param name="values">An array of <see cref="string" /> values to match the beginning of this <see cref="string" /> against.</param>
		/// <returns>
		...
		/// otherwise, <see langword="false" />.
		/// </returns>
		public bool StartsWithAny(string[] values, StringComparison comparison)
		{
			Check.ArgumentNull(str);
			Check.ArgumentNull(values);
			Check.ArgumentEx.ArrayValuesNotNull(values);
		...
		/// </summary>
		/// <param name="values">An array of <see cref="char" /> values to match the beginning of this <see cref="string" /> against.</param>
		/// <returns>
		...
		/// otherwise, <see langword="false" />.
		/// </returns>
		public bool StartsWithAny(char[] values, StringComparison comparison)
		{
			Check.ArgumentNull(str);
			Check.ArgumentNull(values);
		...
		/// </summary>
		/// <param name="values">An array of <see cref="string" /> values to match the end of this <see cref="string" /> against.</param>
		/// <returns>
		...
		/// otherwise, <see langword="false" />.
		/// </returns>
		public bool EndsWithAny(string[] values, StringComparison comparison)
		{
			Check.ArgumentNull(str);
			Check.ArgumentNull(values);
			Check.ArgumentEx.ArrayValuesNotNull(values);
		...
		/// </summary>
		/// <param name="values">An array of <see cref="char" /> values to match the end of this <see cref="string" /> against.</param>
		/// <returns>
		...
		/// otherwise, <see langword="false" />.
		/// </returns>
		public bool EndsWithAny(char[] values, StringComparison comparison)
		{
			Check.ArgumentNull(str);
			Check.ArgumentNull(values);
		...
		/// </summary>
		/// <param name="values">An array of <see cref="string" /> values to search in this <see cref="string" />.</param>
		/// <returns>
		...
		/// otherwise, <see langword="false" />.
		/// </returns>
		public bool ContainsAny(string[] values, StringComparison comparison)
		{
			Check.ArgumentNull(str);
			Check.ArgumentNull(values);
			Check.ArgumentEx.ArrayValuesNotNull(values);
		...
		/// </summary>
		/// <param name="values">An array of <see cref="char" /> values to search in this <see cref="string" />.</param>
		/// <returns>
		...
		/// otherwise, <see langword="false" />.
		/// </returns>
		public bool ContainsAny(char[] values, StringComparison comparison)
		{
			Check.ArgumentNull(str);
			Check.ArgumentNull(values);
		...
		/// A copy of this <see cref="string" /> in which the format items have been replaced by the <see cref="string" /> representation of the corresponding objects in <paramref name="args" />.
		/// </returns>
		public string FormatInvariant(params object?[] args)
		{
			Check.ArgumentNull(str);
			Check.ArgumentNull(args);
		...
		/// </summary>
		/// <param name="value">The <see cref="string" /> that is searched for in this <see cref="string" />.</param>
		/// <returns>
		...
		/// Returns the original <see cref="string" />, if <paramref name="value" /> was not found within this <see cref="string" />.
		/// </returns>
		public string SubstringFrom(string value)
		{
		...
		/// Returns the original <see cref="string" />, if <paramref name="value" /> was not found within this <see cref="string" />.
		/// </returns>
		public string SubstringFrom(string value, bool inclusive)
		{
		...
		/// Returns the original <see cref="string" />, if <paramref name="value" /> was not found within this <see cref="string" />.
		/// </returns>
		public string SubstringFrom(string value, bool inclusive, StringComparison comparison)
		{
			Check.ArgumentNull(str);
		...
		/// </summary>
		/// <param name="value">The <see cref="char" /> that is searched for in this <see cref="string" />.</param>
		/// <returns>
		...
		/// Returns the original <see cref="string" />, if <paramref name="value" /> was not found within this <see cref="string" />.
		/// </returns>
		public string SubstringFrom(char value)
		{
			return str.SubstringFrom(value, false);
		}
		/// <summary>
		...
		/// Returns the original <see cref="string" />, if <paramref name="value" /> was not found within this <see cref="string" />.
		/// </returns>
		public string SubstringFrom(char value, bool inclusive)
		{
			return str.SubstringFrom(value, inclusive, StringComparison.CurrentCulture);
		}
		/// <summary>
		...
		/// Returns the original <see cref="string" />, if <paramref name="value" /> was not found within this <see cref="string" />.
		/// </returns>
		public string SubstringFrom(char value, bool inclusive, StringComparison comparison)
		{
			Check.ArgumentNull(str);
		...
		/// Returns the original <see cref="string" />, if <paramref name="value" /> was not found within this <see cref="string" />.
		/// </returns>
		public string SubstringFromLast(string value)
		{
		...
		/// Returns the original <see cref="string" />, if <paramref name="value" /> was not found within this <see cref="string" />.
		/// </returns>
		public string SubstringFromLast(string value, bool inclusive)
		{
		...
		/// Returns the original <see cref="string" />, if <paramref name="value" /> was not found within this <see cref="string" />.
		/// </returns>
		public string SubstringFromLast(string value, bool inclusive, StringComparison comparison)
		{
			Check.ArgumentNull(str);
			Check.ArgumentNull(value);
		...
		/// Returns the original <see cref="string" />, if <paramref name="value" /> was not found within this <see cref="string" />.
		/// </returns>
		public string SubstringFromLast(char value)
		{
			return str.SubstringFromLast(value, false);
		}
		/// <summary>
		...
		/// Returns the original <see cref="string" />, if <paramref name="value" /> was not found within this <see cref="string" />.
		/// </returns>
		public string SubstringFromLast(char value, bool inclusive)
		{
			return str.SubstringFromLast(value, inclusive, StringComparison.CurrentCulture);
		}
		/// <summary>
		...
		/// Returns the original <see cref="string" />, if <paramref name="value" /> was not found within this <see cref="string" />.
		/// </returns>
		public string SubstringFromLast(char value, bool inclusive, StringComparison comparison)
		{
			Check.ArgumentNull(str);
		...
		/// Returns the original <see cref="string" />, if <paramref name="value" /> was not found within this <see cref="string" />.
		/// </returns>
		public string SubstringUntil(string value)
		{
		...
		/// Returns the original <see cref="string" />, if <paramref name="value" /> was not found within this <see cref="string" />.
		/// </returns>
		public string SubstringUntil(string value, bool inclusive)
		{
		...
		/// Returns the original <see cref="string" />, if <paramref name="value" /> was not found within this <see cref="string" />.
		/// </returns>
		public string SubstringUntil(string value, bool inclusive, StringComparison comparison)
		{
			Check.ArgumentNull(str);
			Check.ArgumentNull(value);
		...
		/// Returns the original <see cref="string" />, if <paramref name="value" /> was not found within this <see cref="string" />.
		/// </returns>
		public string SubstringUntil(char value)
		{
			return str.SubstringUntil(value, false);
		}
		/// <summary>
		...
		/// Returns the original <see cref="string" />, if <paramref name="value" /> was not found within this <see cref="string" />.
		/// </returns>
		public string SubstringUntil(char value, bool inclusive)
		{
			return str.SubstringUntil(value, inclusive, StringComparison.CurrentCulture);
		}
		/// <summary>
		...
		/// Returns the original <see cref="string" />, if <paramref name="value" /> was not found within this <see cref="string" />.
		/// </returns>
		public string SubstringUntil(char value, bool inclusive, StringComparison comparison)
		{
			Check.ArgumentNull(str);
		...
		/// Returns the original <see cref="string" />, if <paramref name="value" /> was not found within this <see cref="string" />.
		/// </returns>
		public string SubstringUntilLast(string value)
		{
		...
		/// Returns the original <see cref="string" />, if <paramref name="value" /> was not found within this <see cref="string" />.
		/// </returns>
		public string SubstringUntilLast(string value, bool inclusive)
		{
		...
		/// Returns the original <see cref="string" />, if <paramref name="value" /> was not found within this <see cref="string" />.
		/// </returns>
		public string SubstringUntilLast(string value, bool inclusive, StringComparison comparison)
		{
			Check.ArgumentNull(str);
			Check.ArgumentNull(value);
		...
		/// Returns the original <see cref="string" />, if <paramref name="value" /> was not found within this <see cref="string" />.
		/// </returns>
		public string SubstringUntilLast(char value)
		{
			return str.SubstringUntilLast(value, false);
		}
		/// <summary>
		...
		/// Returns the original <see cref="string" />, if <paramref name="value" /> was not found within this <see cref="string" />.
		/// </returns>
		public string SubstringUntilLast(char value, bool inclusive)
		{
			return str.SubstringUntilLast(value, inclusive, StringComparison.CurrentCulture);
		}
		/// <summary>
		...
		/// Returns the original <see cref="string" />, if <paramref name="value" /> was not found within this <see cref="string" />.
		/// </returns>
		public string SubstringUntilLast(char value, bool inclusive, StringComparison comparison)
		{
			Check.ArgumentNull(str);
		...
		/// </returns>
		public string PadCenter(int totalWidth)
		{
		...
		/// </returns>
		public string PadCenter(int totalWidth, char paddingChar)
		{
			Check.ArgumentNull(str);
		...
		/// </returns>
		public string TrimStartString(string removedString)
		{
		...
		/// The <see cref="string" /> that remains after all occurrences of <paramref name="removedString" /> are removed from the start of this <see cref="string" />.
		/// </returns>
		public string TrimStartString(string removedString, StringComparison comparison)
		{
		...
		/// </returns>
		public string TrimStartString(string removedString, StringComparison comparison, bool removeOnlyFirst)
		{
			Check.ArgumentNull(str);
		...
		/// </returns>
		public string TrimEndString(string removedString)
		{
		...
		/// The <see cref="string" /> that remains after all occurrences of <paramref name="removedString" /> are removed from the end of this <see cref="string" />.
		/// </returns>
		public string TrimEndString(string removedString, StringComparison comparison)
		{
		...
		/// </returns>
		public string TrimEndString(string removedString, StringComparison comparison, bool removeOnlyFirst)
		{
			Check.ArgumentNull(str);
			Check.ArgumentNull(removedString);
		...
		/// </returns>
		public string EnsureStartsWith(string value)
		{
		...
		/// otherwise, the original <see cref="string" /> with the contents of <paramref name="value" /> appended to the beginning.
		/// </returns>
		public string EnsureStartsWith(string value, StringComparison comparison)
		{
			Check.ArgumentNull(str);
			Check.ArgumentNull(value);
		...
		/// </returns>
		public string EnsureStartsWith(char value)
		{
			return str.EnsureStartsWith(value, StringComparison.CurrentCulture);
		}
		/// <summary>
		...
		/// otherwise, the original <see cref="string" /> with <paramref name="value" /> appended to the beginning.
		/// </returns>
		public string EnsureStartsWith(char value, StringComparison comparison)
		{
			Check.ArgumentNull(str);
		...
		/// </returns>
		public string EnsureEndsWith(string value)
		{
		...
		/// otherwise, the original <see cref="string" /> with the contents of <paramref name="value" /> appended to it.
		/// </returns>
		public string EnsureEndsWith(string value, StringComparison comparison)
		{
			Check.ArgumentNull(str);
			Check.ArgumentNull(value);
		...
		/// </returns>
		public string EnsureEndsWith(char value)
		{
			return str.EnsureEndsWith(value, StringComparison.CurrentCulture);
		}
		/// <summary>
		...
		/// otherwise, the original <see cref="string" /> with <paramref name="value" /> appended to it.
		/// </returns>
		public string EnsureEndsWith(char value, StringComparison comparison)
		{
			Check.ArgumentNull(str);
		...
		/// </returns>
		public string ReplaceMultiple(string? newValue, params string[]? oldValues)
		{
			Check.ArgumentNull(str);
		...
		/// A new <see cref="string" /> where <paramref name="a" /> has been exchanged with <paramref name="b" />.
		/// </returns>
		public string Swap(char a, char b)
		{
			Check.ArgumentNull(str);
		...
		/// </returns>
		public string ChangeCasing(StringCasing casing)
		{
			Check.ArgumentNull(str);
		...
		/// </returns>
		public string ToBase64String(Encoding encoding)
		{
			Check.ArgumentNull(str);
		...
		/// </returns>
		public string FromBase64String(Encoding encoding)
		{
			Check.ArgumentNull(str);
			Check.ArgumentNull(encoding);
		...
		/// A new <see cref="string" />[] that represents the lines of the original <see cref="string" />.
		/// </returns>
		public string[] SplitToLines(bool removeEmptyEntries)
		{
		...
		/// A new <see cref="string" />[] that represents the lines of the original <see cref="string" />.
		/// </returns>
		public string[] SplitToLines(bool removeEmptyEntries, bool trimLines)
		{
			Check.ArgumentNull(str);
		...
		/// </returns>
		public string[] SplitToChunks(int chunkSize)
		{
			Check.ArgumentNull(str);
