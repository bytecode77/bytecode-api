...
namespace BytecodeApi.Mathematics
{
	...
	public static class DateTimeEx
	{
		...
		/// <summary>
		/// Converts a <see cref="uint" /> value representing a unix time stamp to a <see cref="DateTime" /> object, using the <see cref="DateTimeKind.Unspecified" /> kind.
		/// </summary>
		...
		/// </returns>
		public static DateTime ConvertUnixTimeStamp(uint seconds)
		{
			return ConvertUnixTimeStamp(seconds, DateTimeKind.Unspecified);
		}
		/// <summary>
		/// Converts a <see cref="uint" /> value representing a unix time stamp to a <see cref="DateTime" /> object, using the specified <see cref="DateTimeKind" />.
		/// </summary>
		/// <param name="seconds">The seconds starting from 01.01.1970 00:00:00.</param>
		...
		/// A new <see cref="DateTime" /> object whose value is the sum of 01.01.1970 00:00:00 and <paramref name="seconds" />.
		/// </returns>
		public static DateTime ConvertUnixTimeStamp(uint seconds, DateTimeKind kind)
		{
			return new DateTime(1970, 1, 1, 0, 0, 0, kind).AddSeconds(seconds);
		}
		/// <summary>
		/// Converts a <see cref="DateTime" /> value to its equivalent unix time stamp represented as a <see cref="uint" /> value, using the specified <see cref="DateTimeKind" />. If <paramref name="dateTime" /> is out of bounds of the unix epoch, <see langword="null" /> is returned.
		/// </summary>
		...
		/// </returns>
		public static int? ConvertUnixTimeStamp(DateTime dateTime)
		{
			return ConvertUnixTimeStamp(dateTime, DateTimeKind.Unspecified);
		}
		/// <summary>
		/// Converts a <see cref="DateTime" /> value to its equivalent unix time stamp represented as a <see cref="uint" /> value, using the <see cref="DateTimeKind.Unspecified" /> kind. If <paramref name="dateTime" /> is out of bounds of the unix epoch, <see langword="null" /> is returned.
		/// </summary>
		/// <param name="dateTime">The <see cref="DateTime" /> object which is converted to its equivalent unix time stamp representation.</param>
