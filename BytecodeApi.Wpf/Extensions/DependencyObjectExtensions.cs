...
public static class DependencyObjectExtensions
{
	extension(DependencyObject dependencyObject)
	{
		...
		/// </returns>
		public DependencyObject[] GetParents(UITreeType treeType)
		{
			Check.ArgumentNull(dependencyObject);
		...
		/// </returns>
		public T? FindParent<T>(UITreeType treeType) where T : DependencyObject
		{
		...
		/// otherwise, <see langword="null" />.
		/// </returns>
		public T? FindParent<T>(UITreeType treeType, Func<T, bool>? predicate) where T : DependencyObject
		{
			Check.ArgumentNull(dependencyObject);
		...
		/// </returns>
		public T[] FindChildren<T>(UITreeType treeType) where T : DependencyObject
		{
		...
		/// </returns>
		public T[] FindChildren<T>(UITreeType treeType, Func<T, bool>? predicate) where T : DependencyObject
		{
			Check.ArgumentNull(dependencyObject);
		...
		/// </returns>
		public T? FindChild<T>(UITreeType treeType) where T : DependencyObject
		{
		...
		/// </returns>
		public T? FindChild<T>(UITreeType treeType, Func<T, bool>? predicate) where T : DependencyObject
		{
			Check.ArgumentNull(dependencyObject);
		...
		/// otherwise, <see langword="false" />.
		/// </returns>
		public bool Validate(bool validateChildren)
		{
			Check.ArgumentNull(dependencyObject);
