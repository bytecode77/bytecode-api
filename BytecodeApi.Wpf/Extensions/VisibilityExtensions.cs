...
public static class VisibilityExtensions
{
	extension(Visibility visibility)
	{
		...
		/// </summary>
		/// <returns>
		/// <see langword="true" />, if this <see cref="Visibility" /> is equal to <see cref="Visibility.Visible" />;
		/// <see langword="false" />, if this <see cref="Visibility" /> is equal to <see cref="Visibility.Collapsed" />;
