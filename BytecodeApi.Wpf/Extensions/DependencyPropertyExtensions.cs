...
/// <summary>
/// Provides a set of <see langword="static" /> methods for interaction with <see cref="DependencyProperty" /> objects.
/// </summary>
public static class DependencyPropertyExtensions
{
	extension(DependencyProperty)
	{
		...
		/// <para>Example: <see langword="public" /> <see langword="static" /> <see langword="readonly" /> <see cref="DependencyProperty" /> FooProperty = <see cref="DependencyProperty" />.Register(<see langword="nameof" />(Foo));</para>
		/// </summary>
		...
		/// <para>Example: <see langword="public" /> <see langword="static" /> <see langword="readonly" /> <see cref="DependencyProperty" /> FooProperty = <see cref="DependencyProperty" />.Register(<see langword="nameof" />(Foo), new <see cref="PropertyMetadata" />());</para>
		/// </summary>
		/// <param name="name">The name of the dependency property to register. The name must be unique within the registration namespace of the owner type.</param>
		...
		/// <para>Example: <see langword="public" /> <see langword="static" /> <see langword="readonly" /> <see cref="DependencyProperty" /> FooProperty = <see cref="DependencyProperty" />.Register(<see langword="nameof" />(Foo), new <see cref="PropertyMetadata" />(), new <see cref="ValidateValueCallback" />());</para>
		/// </summary>
		/// <param name="name">The name of the dependency property to register. The name must be unique within the registration namespace of the owner type.</param>
		/// <param name="typeMetadata">Property metadata for the dependency property.</param>
		...
		/// <para>Example: <see langword="public" /> <see langword="static" /> <see langword="readonly" /> <see cref="DependencyPropertyKey" /> FooKey = <see cref="DependencyProperty" />.RegisterReadOnly(<see langword="nameof" />(Foo), new <see cref="PropertyMetadata" />());</para>
		/// </summary>
		/// <param name="name">The name of the dependency property to register. The name must be unique within the registration namespace of the owner type.</param>
		/// <param name="typeMetadata">Property metadata for the dependency property.</param>
		/// <returns>
		...
		/// <para>Example: <see langword="public" /> <see langword="static" /> <see langword="readonly" /> <see cref="DependencyPropertyKey" /> FooKey = <see cref="DependencyProperty" />.RegisterReadOnly(<see langword="nameof" />(Foo), new <see cref="PropertyMetadata" />(), new <see cref="ValidateValueCallback" />());</para>
		/// </summary>
		/// <param name="name">The name of the dependency property to register. The name must be unique within the registration namespace of the owner type.</param>
		/// <param name="typeMetadata">Property metadata for the dependency property.</param>
		/// <param name="validateValueCallback">A reference to a user-created callback that should perform any custom validation of the dependency property value beyond typical type validation.</param>
