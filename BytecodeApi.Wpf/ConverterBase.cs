...
public abstract class ConverterBase<TValue> : MarkupExtension, IValueConverter
{
	...
	/// <summary>
	/// Initializes a new instance of the <see cref="ConverterBase{TValue}" /> class.
	/// </summary>
	...
	/// </returns>
	public abstract object? Convert(TValue? value);
	object? IValueConverter.Convert(object value, Type targetType, object parameter, CultureInfo culture)
	{
		object? result = Convert(CSharp.CastOrDefault<TValue>(value));
...
public abstract class ConverterBase<TValue, TParameter> : MarkupExtension, IValueConverter
{
	/// <summary>
	/// Specifies a converter that is used to convert the result of this converter. This can be used to apply multiple conversions on a value.
	/// </summary>
	...
	/// <summary>
	/// Initializes a new instance of the <see cref="ConverterBase{TValue, TParameter}" /> class.
	/// </summary>
	protected ConverterBase()
	{
	}
	...
	/// A converted value. If the method returns <see langword="null" />, the valid null value is used.
	/// </returns>
	public abstract object? Convert(TValue? value, TParameter? parameter);
	object? IValueConverter.Convert(object value, Type targetType, object parameter, CultureInfo culture)
	{
		object? result = Convert(CSharp.CastOrDefault<TValue>(value), CSharp.CastOrDefault<TParameter>(parameter));
		return Then == null ? result : Then.Convert(result, targetType, ThenParameter, culture);
	}
	object? IValueConverter.ConvertBack(object value, Type targetType, object parameter, CultureInfo culture)
	{
