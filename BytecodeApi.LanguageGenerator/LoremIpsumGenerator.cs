...
public class LoremIpsumGenerator : ILanguageStringGenerator
{
	...
	public string Generate()
	{
		...
		int sentences = MathEx.Random.Next(MinParagraphCount, MaxParagraphCount + 1);

		for (int i = 0; i < sentences; i++)
		{
			stringBuilder.AppendLine(MathEx.Random.NextObject(Paragraphs).Trim());
