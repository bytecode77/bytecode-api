namespace BytecodeApi.FileFormats.Coff
{
	...
	public sealed class ImageSectionHeader
	{
		...
		/// <summary>
		/// Gets or sets the total size of the section when loaded into memory. If this value is greater than <see cref="SizeOfRawData" />, the section is zero-padded. This property is valid only for executable images and should be set to zero for object files.
		/// </summary>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="ImageSectionHeader" /> class.
		/// </summary>
