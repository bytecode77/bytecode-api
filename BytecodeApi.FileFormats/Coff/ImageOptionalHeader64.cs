namespace BytecodeApi.FileFormats.Coff
{
	...
	public sealed class ImageOptionalHeader64 : ImageOptionalHeader
	{
		...
		/// <summary>
		/// Gets or sets the size of the stack to reserve. Only <see cref="SizeOfStackCommit" /> is committed; the rest is made available one page at a time until the reserve size is reached.
		/// </summary>
		...
		/// <summary>
		/// Gets or sets the size of the local heap space to reserve. Only <see cref="SizeOfHeapCommit" /> is committed; the rest is made available one page at a time until the reserve size is reached.
		/// </summary>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="ImageOptionalHeader64" /> class.
		/// </summary>
		public ImageOptionalHeader64()
		{
		}
	}
}