...
namespace BytecodeApi.Cryptography
{
	...
	public static class AsymmetricContentEncryption
	{
		...
		{
			Check.ArgumentNull(data, nameof(data));
			Check.Format(data.Length >= Magic.Length && data.GetBytes(0, Magic.Length).Compare(Magic), "The " + nameof(data) + " parameter does not represent a valid " + nameof(AsymmetricContentEncryption) + " binary.");
